...
public class CompletdDonationsAdapter extends RecyclerView.Adapter<CompletdDonationsAdapter.Viewholder> {
    ...
    // Constructor
    public CompletdDonationsAdapter(Context context, ArrayList<Donations> arrayList) {
    ...
    @NonNull
    @Override
    public CompletdDonationsAdapter.Viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull CompletdDonationsAdapter.Viewholder holder, int position) {
